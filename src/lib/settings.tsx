...
'quiz.difficultyLabel': 'Difficulty',
    'quiz.difficultyHint': 'Questions start easy and get harder as the round goes on.',
    'quiz.difficulty.easy': 'Easy',
    'quiz.difficulty.hard': 'Hard',
    'quiz.difficulty.master': 'Master',
  ...
  de: {
    ...
    'quiz.difficultyHint': 'Die Aufgaben starten leicht und werden im Verlauf schwerer.',
    'quiz.difficulty.easy': 'Leicht',
    'quiz.difficulty.hard': 'Schwer',
    'quiz.difficulty.master': 'Meister',
